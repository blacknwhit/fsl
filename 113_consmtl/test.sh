...
CKPT_DEFAULT="/data/xiangyuyue/ULLM-zf/fsl-20260209/runs/113_consmtl_10per/best_combo.pt"
CKPT="${1:-$CKPT_DEFAULT}"
...
if [[ -d "${PROJECT_ROOT}" && -f "${PROJECT_ROOT}/113_consmtl/eval.py" ]]; then
  cd "${PROJECT_ROOT}"
else
