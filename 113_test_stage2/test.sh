...
# Project root that contains the `113_test/` package.
PROJECT_ROOT_DEFAULT="/data/xiangyuyue/ULLM-zf/fsl-20260209"
PROJECT_ROOT="${PROJECT_ROOT:-${PROJECT_ROOT_DEFAULT}}"

if [[ -d "${PROJECT_ROOT}" && -f "${PROJECT_ROOT}/113_test/eval.py" ]]; then
  cd "${PROJECT_ROOT}"
else
...
EVAL_SCRIPT_DEFAULT="${PROJECT_ROOT}/113_test/eval.py"
