...
# Group 2: ours (multitask) + full training data + parameter-efficient finetune.
export LORA_MOE="${LORA_MOE:-1}"
export UNFREEZE_BACKBONE="${UNFREEZE_BACKBONE:-0}"
export SAVE_DIR="${SAVE_DIR:-runs/onlystage2_ours_group2_full_peft}"
