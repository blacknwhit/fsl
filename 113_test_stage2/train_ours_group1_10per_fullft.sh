...
# Group 1: ours (multitask) + 10% training data + full-parameter finetune.
# Keep 10% train split defaults from train_10per.sh.
export LORA_MOE="${LORA_MOE:-1}"
export UNFREEZE_BACKBONE="${UNFREEZE_BACKBONE:-1}"
export SAVE_DIR="${SAVE_DIR:-runs/onlystage2_ours_group1_10per_fullft}"
...
export VALIDATE_LAST_EPOCHS="${VALIDATE_LAST_EPOCHS:-50}"
