...
def combine_matrixwise_top_pair_grads(
    ...
    for matrix_unit in shared_matrix_index.matrix_units:
        ...
        updated_tasks, selection_label, update_mode = _resolve_matrix_unit_update_rule(local_pair_scores)
        ...
        if not updated_tasks:
            continue
        local_pair_weights = _weights_from_task_set(updated_tasks, base_normalized)
