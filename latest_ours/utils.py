...
def save_multitask_checkpoint(
    ...
    *,
    ...
    cfg.setdefault("use_private_experts", bool(getattr(shared, "use_private_experts", True)))
    cfg.setdefault("use_shared_experts", bool(getattr(shared, "use_shared_experts", True)))
