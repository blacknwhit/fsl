...
try:
    ...
    _models = importlib.import_module("113_test.models")
...
def _count_grad_projector_param_count(
    in_channels: int,
    num_classes: int,
    hidden_dim: int,
    out_dim: int = 64,
    ...
    flatten_dim = int(hidden_dim) * int(num_classes)
    out_params = _linear_param_count(flatten_dim, int(out_dim))
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--weight-net-cnt-grad-hidden-dim", type=int, default=64)
