...
def _import_multitask_models():
    ...
    from lora_multitask.models import MultiTaskModel, SharedCLIPVisionBackbone
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Evaluate a multitask checkpoint via full-model loading or legacy single-task wrappers"
    )
