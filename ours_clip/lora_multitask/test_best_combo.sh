...
# Standalone checkpoint test entry for this run's best model.
CKPT_DEFAULT="/data/xiangyuyue/ULLM-zf/fsl-20260209/ours_clip/runs/clip_10per_lora/best_combo.pt"
CKPT="${1:-${CKPT_DEFAULT}}"

# Force project root to ours_clip by default to avoid resolving relative paths in a sibling repo.
