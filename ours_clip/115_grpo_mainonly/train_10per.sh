...
STAGE1_VAL_LAST_K_EPOCHS="${STAGE1_VAL_LAST_K_EPOCHS:-1}"
...
SAVE_DIR="${SAVE_DIR:-runs/ours_10per}"
...
run_post_train_eval() {
  ...
  local stats_dir="${TEST_STATS_DIR:-${SAVE_DIR}/stats_eval_after_train_${ckpt_tag}_$(date +%Y%m%d_%H%M%S)}"
