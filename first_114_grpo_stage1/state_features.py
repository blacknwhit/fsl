...
class SharedExpertStateTracker(nn.Module):
    # 状态只取最后一个 block 的共享专家梯度，再编码成任务级表示。
    def __init__(
        self,
        model,
        *,
    ...
    def extract_features(
        ...
        *,
        ...
        for loss in losses:
            ...
            task_states.append(self._encode_task(expert_a, expert_b))
