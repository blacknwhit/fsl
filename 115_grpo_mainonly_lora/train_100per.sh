...
if [[ -d "${PROJECT_ROOT}" && -f "${PROJECT_ROOT}/115_grpo_mainonly_lora/train.py" ]]; then
  cd "${PROJECT_ROOT}"
else
...
SWANLAB_PROJECT="${SWANLAB_PROJECT:-115_grpo_mainonly_lora}"
...
TRAIN_MODULE="${TRAIN_MODULE:-115_grpo_mainonly_lora.train}"
