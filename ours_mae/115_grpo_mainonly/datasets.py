...
def build_seg_loaders(
    *,
    ...
    train_ds = SegmentationDataset(
        train_dir,
        transform=SegTransform(True, mean, std),
        image_size=image_size,
    )
    val_ds = SegmentationDataset(
        val_dir,
        transform=SegTransform(False, mean, std),
        image_size=image_size,
    )
    train_loader = DataLoader(
        train_ds,
...
def build_cnt_loaders(
    *,
    ...
    train_ds = DSACADensityH5Dataset(
        ...
        transform=CountTransform(True, mean, std),
        image_size=image_size,
    ...
    val_ds = DSACADensityH5Dataset(
        str(val_p),
        num_classes=num_classes,
        transform=CountTransform(False, mean, std),
        image_size=image_size,
        keep_aspect=keep_aspect,
    )
