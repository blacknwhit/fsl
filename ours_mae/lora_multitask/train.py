...
def parse_args():
    p = argparse.ArgumentParser(description="Multi-task training (det/seg/count) with shared ViT-MAE vision backbone")
    ...
    # Backbone
    p.add_argument("--model-name", type=str, default="facebook/vit-mae-large")
