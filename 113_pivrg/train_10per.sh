...
SAVE_DIR="${SAVE_DIR:-runs/113_pivrg_10per}"
...
PIVRG_BASE_DET_AP50="${PIVRG_BASE_DET_AP50:-0.6723}"
PIVRG_BASE_SEG_MIOU="${PIVRG_BASE_SEG_MIOU:-0.6618}"
PIVRG_BASE_CNT_MAE="${PIVRG_BASE_CNT_MAE:-2.5547}"
