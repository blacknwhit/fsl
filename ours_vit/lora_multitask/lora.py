...
def inject_lora_into_dinov3_ffn(backbone: nn.Module, *, cfg: LoRAConfig) -> int:
    """
    Replace timm ViT FFN linear layers with LoRA-augmented ones.
    - Mlp: fc1, fc2
