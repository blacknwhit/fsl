...
# Standalone checkpoint test entry for this ViT run's best model.
CKPT_DEFAULT="/data/xiangyuyue/ULLM-zf/fsl-20260209/ours_vit/runs/lora/best_combo.pt"
CKPT="${1:-${CKPT_DEFAULT}}"
...
# Keep ours_vit package first, and include workspace root for object_detection/segmentation/counting.
