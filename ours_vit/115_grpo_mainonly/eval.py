...
def _check_full_multitask_load_only(checkpoint_path: str, *, device: str | None, model_name: str | None, image_size: int | None) -> None:
    ...
    name = str(model_name or ckpt_config.get("model_name") or "vit_large_patch16_224.orig_in21k")
    img_size = int(image_size) if image_size is not None else int(ckpt_config.get("image_size", 448))
