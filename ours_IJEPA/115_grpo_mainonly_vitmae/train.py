...
def parse_args() -> argparse.Namespace:
    p = argparse.ArgumentParser(description="Two-stage multitask training with IJEPA ViT-H/16 + LoRA-MoE")
    ...
    p.add_argument("--save-dir", type=str, default="runs/115_grpo_mainonly_vitmae")
