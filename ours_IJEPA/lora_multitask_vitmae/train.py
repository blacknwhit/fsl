...
from .models import MultiTaskModel, SharedViTMAEBackboneWithLoRA
...
def parse_args():
    p = argparse.ArgumentParser(description="Multi-task training (det/seg/count) with shared IJEPA ViT-H/16 backbone")
    ...
    p.add_argument("--save-dir", type=str, default="runs/lora_multitask_vitmae")
